    ...
    <section id="about" className="px-6 py-16">
      <div className="grid grid-cols-12 gap-6">
        ...
        <SlideIn direction="left" delay={0} duration={0.6} className="col-span-12 md:col-span-5">
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 relative overflow-hidden h-full transition-all duration-300 cursor-pointer hover:shadow-xl hover:shadow-slate-900/25 hover:scale-[1.02] hover:-translate-y-1">
        ...
        <div className="col-span-12 md:col-span-7 grid grid-cols-2 gap-4">
          ...
          <ScaleIn delay={0.1} className="col-span-2 sm:col-span-1">
            <div className="bg-white rounded-3xl p-6 shadow-sm h-full transition-all duration-300 cursor-pointer hover:shadow-md hover:scale-[1.02] hover:-translate-y-1 group">
              <div className="w-12 h-12 rounded-2xl bg-blue-100 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
          ...
          <ScaleIn delay={0.2} className="col-span-2 sm:col-span-1">
            <div className="bg-white rounded-3xl p-6 shadow-sm h-full transition-all duration-300 cursor-pointer hover:shadow-md hover:scale-[1.02] hover:-translate-y-1 group">
              <div className="w-12 h-12 rounded-2xl bg-emerald-100 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
          ...
          <ScaleIn delay={0.3} className="col-span-2 sm:col-span-1">
            <a href="https://www.zewailcity.edu.eg/academics/undergraduate-studies/program/39" target="_blank" rel="noopener noreferrer" className="block bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-6 h-full transition-all duration-300 cursor-pointer hover:shadow-md hover:scale-[1.02] hover:-translate-y-1 group">
              <div className="w-12 h-12 rounded-2xl bg-amber-100 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
          ...
          <ScaleIn delay={0.4} className="col-span-2 sm:col-span-1">
            <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-3xl p-6 h-full transition-all duration-300 cursor-pointer hover:shadow-md hover:scale-[1.02] hover:-translate-y-1 group">
              <div className="w-12 h-12 rounded-2xl bg-violet-100 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
