  ...
  return (
    <section id="about" className="px-6 py-16">
      <div className="grid grid-cols-12 gap-6">
        {/* Profile Card - Large */}
        <div className="col-span-12 md:col-span-5 bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 relative overflow-hidden">
        ...
        <div className="col-span-12 md:col-span-7 grid grid-cols-2 gap-4">
          {/* Location Card */}
          <div className="col-span-2 sm:col-span-1 bg-white rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="col-span-2 sm:col-span-1 bg-white rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-slate-500 text-sm">5+ Years</p>
          </div>

          {/* Education Card */}
          <div className="col-span-2 sm:col-span-1 bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-6">
          ...
          {/* Languages Card */}
          <div className="col-span-2 sm:col-span-1 bg-gradient-to-br from-violet-50 to-purple-50 rounded-3xl p-6">
